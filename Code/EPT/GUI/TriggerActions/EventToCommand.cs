...
namespace EPT.GUI.TriggerActions
{
    ...
    /// <example>
    /// xmlns:Helpers="clr-namespace:TDSKPro.Core.GUI.Helpers;assembly=TDSKPro.Core.GUI"
    /// xmlns:i="http://schemas.microsoft.com/expression/2009/interactivity"
    /// <Grid Command="{Binding ToggleSelectionCommand}">
        ///    <i:Interaction.Triggers>
    ///           <i:EventTrigger EventName="MouseRightButtonUp">
    ///               <Helpers:EventToCommand Command="{Binding ToggleSelectionCommand}" CommandParameter="Right"></cmd:EventToCommand>
    ///           </i:EventTrigger>
    ///           </i:Interaction.Triggers>
    ///  </Grid>
    /// </example>
